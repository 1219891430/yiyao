<?php if (!defined('THINK_PATH')) exit();?><div class="modal-content" >
    ...
    <form action="" id="submit_form" method="post">
        ...
        <a data-dismiss="modal" id="create_form" class="btn btn-primary">
            <span>确定</span>
        </a>
    </div>
            </div>  
            <div class="col-lg-6" style="border-left: 2px solid #00e0bc;">
            	<iframe id="iframe" name="miframe" src="/index.php/Admin/PresaleSummary/setting?staff_id=<?php echo ($param['staff_id']); ?>&index=<?php echo ($param['index']); ?>" class="col-md-12" style="height: 650px;"></iframe>
    ...
    <script type="text/javascript">
        ...
        $("#allshop").click(function(){
        	...
        	if(checked=="checked"){
        		$(".shopIds").attr("checked","checked");
        	}else{
        		$(".shopIds").attr("checked",false);
        	}
        });
