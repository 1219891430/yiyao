...
<script type="text/javascript" src="/nlh_zdb/Public/assets/js/jquery.validate.min.js"></script>
...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="row-fluid main-content">
        ...
        <?php echo W('Page/page',array("/nlh_zdb/index.php/Admin/Depot/index",$pnum,$pagelist,array())) ;?>
...
<div id="await" class="await"><span> <img src="/nlh_zdb/Public/assets/images/loding.gif" title="加载图片"/></span></div>
<!--新建弹出层开始-->
...
<script type="text/javascript">
    ...
    $("#cre_c").click(function () {
        $.ajax({
            url: "/nlh_zdb/index.php/Admin/Depot/addDepot/r/"+new Date().getTime(),
            type: "get",
            dataType: "html",
            beforeSend: function () {
                $(".await").show();
    ...
    $(".edit").click(function () {
        $.ajax({
            url: "/nlh_zdb/index.php/Admin/Depot/editDepot/r/"+new Date().getTime(),
            type: "get",
            dataType: "html",
