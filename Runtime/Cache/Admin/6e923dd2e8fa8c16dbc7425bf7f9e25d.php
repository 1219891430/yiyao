...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="row-fluid main-content">
        <!--右侧查询开始-->
            <div class="sel-data mb20">
                ...
                <select id="staff_id" class="w200 form-control">
                   ...
                   <input type="text" id="cust" value="<?php echo ($urlPara['cust']); ?>" class="w150 form-control"  placeholder="请输入购货方">
            ...
            <table class="table list_table" id="role_table">
                ...
                <tbody>
                  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr id="tr_<?php echo ($list["order_id"]); ?>">
                        ...
                        <td  style="text-align: center"><?php echo ($list["cust_name"]); ?></td>
                        <td  style="text-align: center"><?php echo ($list["order_total_money"]); ?></td>
                        <!--<td><?php echo ($list["order_real_money"]); ?></td>-->
                        <td  style="text-align: center">
                            <?php switch($list["order_way"]): case "1": ?>货到付款<?php break;?>
                        ...
                        <td  style="text-align: center"><?php echo ($list["true_name"]); ?></td>
                        <td  style="text-align: center">
                        	<?php if($list["order_from"]==2){ ?>
                        		业务员
                        	<?php }elseif($list["order_from"]==3){ ?>
                        		商城下单
                        	<?php }else{ ?>
                        		采单人员
                        	<?php } ?>
                        ...
                        <td  style="text-align: center">
                            <?php switch($list["order_status"]): case "1": ?>已下单<?php break;?>
                        ...
                        <td style="text-align: center">
                            <ul class="operate-menu li-width22">
                                ...
                                <!--<?php if($deltype != 1 ): ?><li style="width:15%">
                                        <a href="<?php echo U('Home/PlanOrder/look', array( 'id' => $list['order_id'],'print' => 1 ));?>" title="打印" class="collapsed collapse-menu icons-href" target="_blank"><i class="icon-edit"></i>打印</a>
                                    </li><?php endif; ?>-->
        ...
        <!--分页查询开始-->
        <?php echo W('Page/page',array("/index.php/Admin/PresaleOrder/index",$pnum,$pagelist,$aUrlPara));?>
        <!--分页查询结束-->
        </div>
...
<script type="text/javascript" src="/Public/assets/js/orgGoods.js?v=27"></script>
<script type="text/javascript">
    $(function(){
	...
	$("#cre_order").click(function(){
        ajaxData("/index.php/Admin/PresaleOrder/add");
    })
    //部门联动
    ...
    $("#find").click(function(){
        ...
        var h = "/index.php/Admin/PresaleOrder?"
    ...
    $(".look").click(function(){
        ...
        ajaxDataPara("/index.php/Admin/PresaleOrder/look/r/" + new Date().getTime(),data);
    })
</script>
