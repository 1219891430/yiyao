...
<div class="modal-content modal_850">
    ...
    <form action="<?php echo U('Admin/Dealer/add');?>" method="post" enctype="multipart/form-data"  id="submit_form">
        <div class="modal-body modal_850">
            <table class="table no_border">
                ...
                <tr>
                    ...
                    <td>固话：</td><td>
                    <input type="text" name="telephone" id="telephone"  value="<?php echo ($org_info["telephone"]); ?>"  class="w200 form-control">
                    </td>
                </tr>
                <tr>
                    <td>邮编：</td>
                ...
                <tr>
                    ...
                    <td>老板数量：</td>
                    <td><input type="number" name="boss_num" value="2" class="w100 form-control"></td>
                    <td>业务员数量：</td>
                    <td><input type="number"  name="saleman_num" value="10" class="w100 form-control"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td>内勤数量：</td>
                    <td>
                        <input type="number"  name="work_num" value="2" class="w100 form-control">
                    </td>
                </tr>
