    ...
    <form action="" id="submit_form" method="post">
        ...
        <div class="modal-body modal_850">
            ...
            <select name="depot" id="depot_id">
                ...
                <?php if(is_array($depot)): foreach($depot as $key=>$d): ?><option value="<?php echo ($d["repertory_id"]); ?>"><?php echo ($d["repertory_name"]); ?></option><?php endforeach; endif; ?>
...
<SCRIPT type="text/javascript">
    ...
    $("#submit_set").click(function () {
        ...
        $.ajax({
            ...
            success: function (d) {
                if(d.status) {
                    alert('设置成功')
                    window.location.href = "<?php echo U('/Admin/Role/index');?>"
                } else {
                    alert('设置失败')
                    window.location.href = "<?php echo U('/Admin/Role/index');?>"
                }
    ...
    function setMenuCheck(depot_id,role_id) {
        var url = "<?php echo U('/Admin/Role/getMenuIds');?>";
