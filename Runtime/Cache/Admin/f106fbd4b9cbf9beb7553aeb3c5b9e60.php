<?php if (!defined('THINK_PATH')) exit();?><div class="modal-content modal_850">
        ...
        <div class="modal-body modal_850">
            <table class="table no_border">
                ...
                <tr>
                    ...
                    <td>
                        <span class="f16 fb"><?php echo ($code); ?></span>
                ...
                <tr>
                    ...
                    <td>
                        <select id="apage_staff_id" name="staff_id" class="w200 form-control">
                            ...
                            <?php if(is_array($aStaff)): $i = 0; $__LIST__ = $aStaff;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$avo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($avo["admin_id"]); ?>"><?php echo ($avo["true_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </td>
                    <td class="tr"></td>
                    <td>
    ...
    <script type="text/javascript">
        ...
        $("#find_goods").click(function(){
        	$depot_id = $("#depot_ids").val();
            if($("#goods").val()!="")
                queryGoodsList("<?php echo U('Admin/GoodsInfo/selGoods');?>", $("#brand").val(), $("#goods").val(), $depot_id,0,0,0);
            else
                alert("请填写商品");
        });
        ...
        $("#brand").change(function(){
            if($("#brand").val()==0 && $("#goods").val()==""){
            	...
            	$depot_id = $("#depot_ids").val();
                queryGoodsList("<?php echo U('Admin/GoodsInfo/selGoods');?>", $("#brand").val(), '', $depot_id,0,0,0);
            }
        });
...
//                alert("未查询到供应商信息,请先搜索选择供应商");
                ...
                ajaxDataAUD("/index.php/Admin/DeliverApply/add",data,true)
            }
        }
    </script>
</div>