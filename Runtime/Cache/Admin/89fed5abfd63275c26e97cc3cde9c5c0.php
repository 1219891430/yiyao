...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="row-fluid main-content">
        <!--右侧查询开始-->
            ...
            <?php echo W('Page/page',array("/yiyao/index.php/Admin/DepotStock/index",$pnum,$pagelist,$urlPara));?>
        </div>
...
<script>
	...
	$("#find").click(function(){
        location.href="/yiyao/index.php/Admin/DepotStock/index/org_id/"+$("#org_id").val()+"/depot_id/"+$("#depot_id").val()+"/op_brand/"+$("#op_brand").val()+"/goods_name/"+$("#goods_name").val();
    })
	$("#export").click(function(){
        location.href="/yiyao/index.php/Admin/DepotStock/index/export/export/depot_id/"+$("#depot_id").val()+"/op_brand/"+$("#op_brand").val()+"/goods_name/"+$("#goods_name").val();
    })
</script>
