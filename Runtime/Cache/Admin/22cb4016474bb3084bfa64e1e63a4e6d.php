        ...
        <!--右侧查询开始-->
            ...
            <table class="table list_table" id="role_table">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (getDeliverWay($vo["order_way"])); ?></td>
                       <!--  <td><?php echo ($vo["status_name"]); ?></td> -->
                        <td><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></td>
                        <td><?php if($vo['is_full_pay']){echo "已结清";}else{ echo "未结清";} ?></td>
...
-->                        </ul></td>
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/index.php/Admin/DeliverOrder/index",$pnum,$pagelist,$query));?>
            <!--分页查询结束-->
        </div>
...
<script type="text/javascript">
    ...
    $("#find").click(function() {
        ...
        location.href="/index.php/Admin/DeliverOrder/index"+con;
    });
    ...
    $(".detail").click(function(){
        ...
        ajaxDataPara("/index.php/Admin/DeliverOrder/detail",data);
    });
</script>
</body>
