...
<head>
    ...
    <link href="/yiyao/Public/assets/css/jquery.treetable.css" rel="stylesheet">
    <link href="/yiyao/Public/assets/css/jquery.treetable.theme.default.css" rel="stylesheet">
    <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/yiyao/Public/assets/js/layer/layer.js"></script>
...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
            ...
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/yiyao/index.php/Admin/Dealer/index",$pnum,$pagelist,$aUrlPara));?>
            <!--分页查询结束-->
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $("#chuangjian").click(function(){
        ajaxData("/yiyao/index.php/Admin/Dealer/add");
    })
    $(".editjing").click(function(){
        var data={ org_id:$(this).attr("attr")};
        ajaxDataPara("/yiyao/index.php/Admin/Dealer/edit",data);
    })
    $(".chakan").click(function(){
        var data={ org_id:$(this).attr("attr")};
        ajaxDataPara("/yiyao/index.php/Admin/Dealer/total",data);
    })
    ...
    $("#find").click(function(){
        ...
        /*var h = "/yiyao/index.php/Admin/Dealer?"
        ...
        location.href="/yiyao/index.php/Admin/Dealer?dep_id="+$("#dep_id").val();
    })
