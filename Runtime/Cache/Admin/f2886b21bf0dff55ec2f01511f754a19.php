        ...
        <div class="sel-data mb20">
            ...
            <table class="table list_table">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                            <?php switch($vo["return_status"]): case "1": ?>已提交<?php break;?>
                                <?php case "2": ?><span style="color: green">已审核</span><?php break;?>
                                <?php case "3": ?><span style="color: red">已入库</span><?php break;?>
                        ...
                        <td>
                            <ul class="operate-menu li-width25">
                                ...
                                <li style="width:15%">
                                    <a attr="<?php echo ($vo["return_id"]); ?>" class="collapsed collapse-menu icons-href return_look" href="javascript:void(0)">
                                        <i class="icon-edit"></i>查看
                                    </a></li>
                              <?php if($vo['return_status']==1){ ?>
                                <li style="width:15%"><a attr="<?php echo ($vo["return_id"]); ?>" attr_status="2" class="collapsed collapse-menu icons-href return_edit" id="edit" href="javascript:void(0)">
                                    <i class="icon-edit"></i>修改
                                </a></li>
                                <li style="width:15%"><a attr="<?php echo ($vo["return_id"]); ?>" attr_status="2" class="collapsed collapse-menu icons-href return_check" id="edit" href="javascript:void(0)">
                                    <i class="icon-edit"></i>审核
                                </a></li>
                              <?php } ?>
                                <li style="width:15%"><a attr="<?php echo ($vo["return_id"]); ?>" attr_status="2" class="collapsed collapse-menu icons-href return_excel" id="excel"  href="javascript:void(0)">
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/index.php/Admin/DeliverBack/index",$pnum,$pagelist,$urlPara));?>
...
<script type="text/javascript">
    ...
    $("#find").click(function(){
        ...
        var h = "/index.php/Admin/DeliverBack?"
    ...
    $("#cre_apply").click(function(){
        ajaxData("/index.php/Admin/DeliverBack/add");
    })
    $(".return_edit").click(function(){
        var data={id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Admin/DeliverBack/edit",data);
    })
    $(".return_look").click(function(){
        var data={id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Admin/DeliverBack/look",data);
    })
    
     $(".return_check").click(function(){
        var data={id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Admin/DeliverBack/check",data);
    })

    $("#find").click(function(){
        location.href="/index.php/Admin/DeliverBack?depot_id="+$("#depot_id").val() + "&staff_id=" + $("#staff_id").val() + "&start=" + $("#start_time").val() + "&end=" + $("#end_time").val();
    })

    $(".return_excel").click(function(){
        id = $(this).attr("attr");
        console.log(id)
        location.href="/index.php/Admin/DeliverBack/look?excel=excel&id=" + id;
    })
