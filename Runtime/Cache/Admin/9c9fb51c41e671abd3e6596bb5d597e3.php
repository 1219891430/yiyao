...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
           ...
           <?php echo W('Page/page',array("/yiyao/index.php/Admin/DepotOut/index",$pnum,$pagelist,$urlPara));?>
...
<script type="text/javascript">
    ...
    $(".print").click(function(){
    	...
    	location.href="/yiyao/index.php/Admin/DepotOut/show/print/print/depot_out_id/"+depot_out_id;
    });
    
    
    $("#cre_out").click(function(){
        ajaxData("/yiyao/index.php/Admin/DepotOut/add");
    })
    $(".out_edit").click(function(){
        var data={depot_out_id:$(this).attr("attr")};
        ajaxDataPara("/yiyao/index.php/Admin/DepotOut/edit",data);
    })
    $(".out_shenhe").click(function(){
        var data={depot_out_id:$(this).attr("attr")};
        ajaxDataPara("/yiyao/index.php/Admin/DepotOut/outPass",data);
    })
    
    $(".out_show").click(function(){
    	var data={depot_out_id:$(this).attr("attr")};
        ajaxDataPara("/yiyao/index.php/Admin/DepotOut/show",data);
    });
    $("#find").click(function(){
        ...
        if((start==0&&end!=0)||(start!=0&&end==0))
            ...
            location.href="/yiyao/index.php/Admin/DepotOut/index/depot_id/"+$("#depot").val()+"/out_type/"+$("#out_type").val()+"/out_status/"+$("#out_status").val()+"/start_time/"+start+"/end_time/"+end;
    })
</script>
