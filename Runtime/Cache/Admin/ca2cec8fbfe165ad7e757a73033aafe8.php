                      ...
                      <tr>
                       ...
                       <tr id="peisong" style="display: none;">
                        ...
                        <select name="send_staff_id" id="send_staff_id" class="w200 form-control">
                            ...
                            <?php if(is_array($psStafflist)): $i = 0; $__LIST__ = $psStafflist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$dvo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($dvo["admin_id"]); ?>"><?php echo ($dvo["true_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                      </tr>
	...
	$("#brand").change(function(){
        ...
        function depotIn(){
            ...
            else
            {
                ...
                ajaxDataAUD("/index.php/Admin/DepotOut/addex",data,true)
            }
        }
