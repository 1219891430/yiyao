...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="row-fluid main-content">
        <!--右侧查询开始-->
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
          <?php echo W('Page/page',array("/yiyao/index.php/Admin/DepotLog/index",$pnum,$pagelist,$urlPara));?>
...
<script>
	...
	$("#find").click(function(){
        location.href="/yiyao/index.php/Admin/DepotLog/index/depot_id/"+$("#depot").val()+"/goods_name/"+$("#name").val();
    })
</script>
