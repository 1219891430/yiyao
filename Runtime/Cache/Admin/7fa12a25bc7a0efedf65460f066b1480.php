...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
            ...
            <?php echo W('Page/page',array("/index.php/Admin/DepotIn/index",$pnum,$pagelist,$urlPara));?>
...
<script type="text/javascript">
    ...
    $("#cre_in").click(function(){
        ajaxData("/index.php/Admin/DepotIn/add");
    })
    $(".in_edit").click(function(){
        var data={depot_in_id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Admin/DepotIn/edit",data);
    })
    $(".in_shenhe").click(function(){
        var data={depot_in_id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Admin/DepotIn/inPass",data);
    })
    
    $(".show").click(function(){
        var data={depot_in_id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Admin/DepotIn/show",data);
    })
    
    $(".print").click(function(){
    	var depot_in_id=$(this).attr("attr");
        
    	location.href="/index.php/Admin/DepotIn/show/print/print/depot_in_id/"+depot_in_id;
    });
    $("#find").click(function(){
        ...
        if((start==0&&end!=0)||(start!=0&&end==0))
            ...
            location.href="/index.php/Admin/DepotIn/index/depot_id/"+$("#depot").val()+"/in_status/"+$("#in_status").val()+"/in_type/"+$("#in_type").val()+"/start_time/"+start+"/end_time/"+end;
    });
