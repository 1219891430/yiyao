        ...
        <!--右侧查询开始-->
            ...
            <table class="table list_table" id="role_table">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td style="text-align: center"><?php echo ($vo["change_code"]); ?></td>
                        <td style="text-align: center"><?php echo ($vo["cust_name"]); ?></td>
                        <td style="text-align: center"><?php echo ($vo["contact"]); ?></td>
                        <td style="text-align: center"><?php echo ($vo["true_name"]); ?></td>
                        ...
                        <td style="text-align: center"><?php echo ($vo["order_total_money"]); ?></td>
                        
                       <!--  <td><?php echo ($vo["status_name"]); ?></td> -->
                        <td style="text-align: center"><?php echo (date('Y-m-d H:i:s',$vo["add_time"])); ?></td>
                        <td style="text-align: center"><?php if($vo["is_cancel"] == 1): ?><span style="color: red">已取消(<?php echo date('Y-m-d H:i:s', $vo['cancel_time']);?>)</span>  <?php else: ?> 正常<?php endif; ?></td></td>
                        <td style="text-align: center"><ul class="operate-menu li-width50">
                                <li><a attr="<?php echo ($vo["change_id"]); ?>" class="look collapsed collapse-menu icons-href detail" href="javascript:void(0)">
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/index.php/Admin/PresaleChange/index",$pnum,$pagelist,$aUrlPara));?>
            <!--分页查询结束-->
        </div>
...
<script type="text/javascript">
    ...
    $("#find").click(function(){
        ...
        var h = "/index.php/Admin/PresaleChange?"
    ...
    $(".look").click(function(){
        ...
        ajaxDataPara("/index.php/Admin/PresaleChange/look/r/" + new Date().getTime(),data);
    })
</script>
