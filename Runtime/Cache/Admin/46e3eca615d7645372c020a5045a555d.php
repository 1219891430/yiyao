...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="row-fluid main-content">
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/index.php/Admin/DeliverChange/index",$pnum,$pagelist,$query));?>
            <!--分页查询结束-->
        </div>
...
<script type="text/javascript">
    ...
    $("#find").click(function() {
        ...
        location.href="/index.php/Admin/DeliverChange/index"+con;
    });
    ...
    $(".detail").click(function(){
        ...
        ajaxDataPara("/index.php/Admin/DeliverChange/detail",data);
    });
</script>
</body>
