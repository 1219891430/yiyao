        ...
        <div class="modal-body modal_850">
            <table class="table no_border">
                ...
                <tr>
                    <td>出库仓库：</td>
                    <td class="tl">
                        <input class="w200 form-control" type="text" disabled value="<?php echo ($return["repertory_name"]); ?>">
                    </td>
                    ...
                    <td>
                        <input class="w200 form-control" type="text" disabled value="<?php echo ($return["return_code"]); ?>">
                    </td>
                ...
                <tr>
                    <td>业务员</td>
                    <td>
                        <input class="w200 form-control" type="text" disabled value="<?php echo ($return["staff_name"]); ?>">
                    </td>
                    <td class="tr"></td>
                    <td>
                    </td>
                ...
                <tr>
                    <td>备注：</td>
                    <td colspan="3">
                        <input class="w300 form-control" type="text" disabled value="<?php echo ($return["return_remark"]); ?>">
                    </td>
                </tr>
                </tbody>
                <tfoot></tfoot>
            ...
            <table class="table list_table" id="goods_table">
                ...
                <?php if(is_array($goods)): $i = 0; $__LIST__ = $goods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="goods_add_tr">
                    ...
                    <td><?php echo (getGoodsNum($vo["goods_num"])); ?></td>
