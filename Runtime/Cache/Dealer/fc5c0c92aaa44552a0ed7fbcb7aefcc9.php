            ...
            <table class="table list_table" id="role_table">
                ...
                <?php if(is_array($aOrder)): $i = 0; $__LIST__ = $aOrder;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($vo["way_name"]); ?></td>
                         <td class="center">
                             <?php if($vo["is_full_pay"] == 1): ?>结清
                                 <?php else: ?>
                                 赊欠<?php endif; ?>
                         </td>
                        <td><?php echo ($vo["time"]); ?></td>
                        <td><ul class="operate-menu li-width50">
                                <li><a attr="<?php echo ($vo["order_id"]); ?>" class="collapsed collapse-menu icons-href detail" href="javascript:void(0)">
                                    <i class="icon-edit"></i>查看
                                </a></li>
                                
<!--                                <li style="width:33%"><a href="<?php echo U('detail',array('print'=>1,'code' => $vo['order_id']));?>" target="_blank">打印</a></li>
-->                        </ul></td>
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/index.php/Dealer/CarSalesOrder/index",$pnum,$pagelist,$urlPara));?>
            <!--分页查询结束-->
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(".detail").click(function(){
        ...
        ajaxDataPara("/index.php/Dealer/CarSalesOrder/detail",data);
    })
    $("#find").click(function(){
        ...
        if((start==0&&end!=0)||(start!=0&&end==0))
            ...
            location.href="/index.php/Dealer/CarSalesOrder/index/staff_id/"+$("#staff_id").val()+"/way/"+$("#way").val()+"/name/"+cust_name+"/start_time/"+start+"/end_time/"+end;
    })
</script>
</body>
</html>