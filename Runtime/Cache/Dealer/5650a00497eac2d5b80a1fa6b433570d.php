        ...
        <div class="row-fluid main-content">
            ...
            <table class="table list_table">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        <td><?php echo ($vo["act_name"]); ?></td>
                        <!--<td><?php echo ($vo["supp_name"]); ?></td>-->
                        <td>
                        	<?php if($vo["act_type"]==0){ echo "售价"; }elseif($vo["act_type"]==1){ echo "满额"; }elseif($vo["act_type"]==2){ echo "赠品"; } ?>
                        </td>
                        <td><?php echo ($vo["act_note"]); ?></td>
                        <td>
                        	<?php if($vo["is_close"]){ echo "关闭"; }else{ echo "开启"; } ?>
                        </td>
                        <td><?php echo (date("Y-m-d",$vo["start_time"])); ?></td>
                        <td><?php echo (date("Y-m-d",$vo["end_time"])); ?></td>
                        <td><ul class="operate-menu li-width25">
                                <li><a attr="<?php echo ($vo["act_id"]); ?>"  class="collapsed collapse-menu icons-href detail" href="javascript:void(0)">
                                    <i class="icon-edit"></i>查看
                                </a></li>
                                <li><a attr="<?php echo ($vo["act_id"]); ?>"  class="collapsed collapse-menu icons-href edit" href="javascript:void(0)">
                                    <i class="icon-edit"></i>修改
                                </a></li>
                                
                                <li><a attr="<?php echo ($vo["act_id"]); ?>"  class="collapsed collapse-menu icons-href delete" href="javascript:void(0)">
                                    <i class="icon-edit"></i>删除
                                </a></li>
                                <?php if($vo["is_close"]){ ?>
                                <li><a attr="<?php echo ($vo["act_id"]); ?>"  class="collapsed collapse-menu icons-href open" href="javascript:void(0)">
                                    <i class="icon-edit"></i>开启
                                </a></li>
                                <?php }else{ ?>
                                <li><a attr="<?php echo ($vo["act_id"]); ?>"  class="collapsed collapse-menu icons-href close1" href="javascript:void(0)">
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/index.php/Dealer/Promotion/index",$pnum,$pagelist,$urlPara));?>
...
<script type="text/javascript">
    ...
    $("#cre_apply").click(function(){
        ajaxData("/index.php/Dealer/Promotion/add");
    })
    $(".edit").click(function(){
        var data={act_id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Dealer/Promotion/edit",data);
    })
    
    
    $(".detail").click(function(){
        var data={act_id:$(this).attr("attr")};
        ajaxDataPara("/index.php/Dealer/Promotion/detail",data);
    })
    ...
    $(".open").click(function(){
    	if(confirm("确定要开启吗")){
        	...
        	$.post("/index.php/Dealer/Promotion/open",data,function(res){
        		if(res==1){
        			alert("开启成功");
        			location.reload();
        		}else{
    ...
    $(".close1").click(function(){
        ...
        var act_id=$(this).attr("attr");
        var data={act_id:act_id};
        $.post("/index.php/Dealer/Promotion/close",data,function(res){
        	if(res==1){
        		alert("关闭成功");
        		location.reload();
        	}else{
    ...
    $(".delete").click(function(){
        ...
        var act_id=$(this).attr("attr");
        var data={act_id:act_id};
        $.post("/index.php/Dealer/Promotion/delete",data,function(res){
        	if(res==1){
        		alert("删除成功");
        		location.reload();
        	}else{
    ...
    $("#find").click(function(){
        ...
        var name=$("#name").val();
        location.href="/index.php/Dealer/Promotion/index/name/"+name;
    })
</script>
</body>
</html>