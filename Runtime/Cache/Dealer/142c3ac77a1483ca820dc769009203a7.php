...
<div id="show_img">
    <img id="img_del" src="/yiyao/Public/assets/images/close.png"/>
    <img id="img_src" src="" >
</div>
<div id="top">
<div class="navbar">
...
<div class="row-fluid main-content">
    ...
    <?php echo W('Page/page',array("/yiyao/index.php/Dealer/Customer/index",$pnum,$pagelist,array("staff_id"=>$staff_id)));?>
</div>
<!--主体操作区域结束-->
...
<script type="text/javascript">
    ...
    function addMarker(j,w){
        marker = new AMap.Marker({
            icon:"/yiyao/Public/assets/images/mark.png",
...
<script type="text/javascript">
    ...
    $("#cre_c").click(function () {
        $.ajax({
            url: "/yiyao/index.php/Dealer/Customer/addCustomer/r/"+new Date().getTime(),
            type: "get",
            dataType: "html",
            beforeSend: function () {
                $(".await").show();
    ...
    $("#updateAll").click(function(){
    	...
    	ajaxDataPara("/yiyao/index.php/Dealer/Customer/updateAll",data);
    });
    ...
    $("#find").click(function(){
        ...
        location.href="/yiyao/index.php/Dealer/Customer/index"+con;
    })
