...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
            ...
            <thead>
            <tr><td width="20%">类别名称</td>
            <td width="30%">备注</td>
            <td width="10%">状态</td>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($class)): $i = 0; $__LIST__ = $class;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cvo): $mod = ($i % 2 );++$i;?><tr>
            <td><?php echo ($cvo["class_name"]); ?></td>
            <td><?php echo ($cvo["remark"]); ?></td>
            <td class='<?php if($cvo["is_close"] == 1): ?>red<?php else: ?>green<?php endif; ?>'>                                          
            <?php if($cvo["is_close"] == 1): ?>关闭<?php else: ?>正常<?php endif; ?>
            </td>
