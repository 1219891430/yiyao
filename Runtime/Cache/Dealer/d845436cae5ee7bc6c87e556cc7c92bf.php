...
<script language="javascript">
    ...
    function getRoute()
    {
        ...
        $.ajax({
            url:"/index.php/Dealer/Action/sd_selRoute",
            type:"post",
    ...
    {
        $.ajax({
            url:"/index.php/Dealer/Action/selNowRoute",
            type:"post",
            data:{staff_id:$("#staff").val(),today:$("#route_time").val()},
            dataType:"json",
            beforeSend:function(){
    ...
    function routeData()
    {
        $(".route-data").click(function(){
            ...
            ajaxDataPara("/index.php/Dealer/Action/"+$(this).attr("attr"),para);
        })
    }
    //type为true  间隔提取时间
...
<script type="text/javascript">
    $(function () {
        ...
        $("#search").click(function(){
            ...
            location.href="/index.php/Dealer/Action/index/today/"+$("#route_time").val()+"/staff_id/"+$("#staff").val();
        })
        //设置行动轨迹人员
        $("#cre_rousta").click(function(){
            $.ajax({
                url:"/index.php/Dealer/Action/selStaffRoute",
                type:"get",
                dataType:"html",
                beforeSend:function(){
                    $(".await").show();
        ...
        $(".task_edit").click(function()
        {
            ...
            $.ajax({
                url:"/index.php/Dealer/Action/edit",
                type:"get",
                dataType:"html",
