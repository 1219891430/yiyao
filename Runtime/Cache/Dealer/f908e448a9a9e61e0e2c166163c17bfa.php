...
<div class="widget">
    <div class="whead">
            ...
            <form action="<?php echo U('Dealer/OrderReport/shops');?>" method="get" id="formId">
    ...
    <div class="clear"></div>
             ...
             <thead>
                ...
                <tbody class="f12">
                    <?php if(is_array($newData)): $i = 0; $__LIST__ = $newData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr >
                            <td rowspan="<?php echo ($d["totalnum"]); ?>"><?php echo ($d["cust_name"]); ?></td>
                            <?php if(is_array($d["total"])): $i = 0; $__LIST__ = $d["total"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ds): $mod = ($i % 2 );++$i;?><td><?php echo ($ds["good_name"]); ?></td>
                                    <td><?php echo ($ds["unit_name"]); ?></td>
                                    <td><?php echo ($ds["singleprice"]); ?>
                                    <?php if($ds['cuxiao'] == 0): ?><!-- 商品 -->
                                    <?php elseif($ds['cuxiao'] == 1): ?>
                                        
                                    
                                        <span style="color:red;">(促)</span><?php endif; ?>
                                    </td>
                                    <td><?php echo ($ds["num"]); ?></td>
                                    <td><?php echo (number_format($ds["allprice"],2)); ?>元</td>
                                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                        <tr>
                            <td style="text-align:right;font-weight:bold" colspan="6">促销品小结：<span style="color:blue;font-weight:bold"><?php if($d['allcuxiao']==null){echo '0';}else{echo $d['allcuxiao'];} ?></span> </span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;小结：<span style="color:blue;font-weight:bold"> <?php if($d['allmoney']==null){echo '0';}else{echo $d['allmoney'];} ?></span>元&nbsp;</td> 
                        </tr>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    <tr>                 
                       <td style="text-align:right;font-weight:bold" colspan="6">促销品总金额：<span style="color:red;font-weight:bold"><?php echo ($tonum["cuxiaomoney"]); ?></span>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;总金额：<span style="color:red;font-weight:bold"><?php echo ($tonum["totalmoney"]); ?></span>元&nbsp;</td> 
                    </tr>
                </tbody>
                 <tfoot>
                </tfoot>
            ...
            <table border="1px" cellpadding="0" cellspacing="0" width="100%">
                ...
                <?php if(is_array($sData)): $i = 0; $__LIST__ = $sData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sData): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <tr>
                        <td style="text-align:right;font-size:14px;" colspan="6">实收：<b><?php echo ($sData["realm"]); ?></b> 元</td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
                 <tfoot>
                    <tr>                 
            ...
            <thead>
                ...
                <tbody class="f12">
                    <?php if(is_array($newTData)): $i = 0; $__LIST__ = $newTData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr >
                            <td rowspan="<?php echo ($d["totalnum"]); ?>"><?php echo ($d["cust_name"]); ?></td>
                            <?php if(is_array($d["total"])): $i = 0; $__LIST__ = $d["total"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ds): $mod = ($i % 2 );++$i;?><td><?php echo ($ds["goods_name"]); ?>(<?php echo ($ds["goods_spec"]); ?>)</td>
                        ...
                        <tr>
                            <td style="text-align:right;font-weight:bold" colspan="6">实际小结：<span style="color:blue;font-weight:bold"><?php echo ($d["totalmoney"]); ?> </span>元&nbsp;</td> 
                        </tr>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    <tr>                 
