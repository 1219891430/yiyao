    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
            ...
            <div class="sel-data mb20">
                <div class="fl"></div>
                <div class="fr"><a class="btn btn-primary bg_3071a9" href="#" id="cre_bm" role="button">创建</a></div>
            </div>
            ...
            <td width="15%">部门名称</td>
            <td width="15%">归属机构</td>
            <td width="11%">部门负责人</td>
            <td width="13%">操作</td>
            </tr>
            </thead>
            <tbody>
            <?php if(is_array($dep)): $i = 0; $__LIST__ = $dep;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$da): $mod = ($i % 2 );++$i;?><tr id="tr_<?php echo ($da["dep_id"]); ?>" data-tt-id="<?php echo ($da["dep_id"]); ?>">
            <td><?php echo ($da["dep_name"]); ?></td>
            <td><?php echo session("org_parent_name");?></td>
            <td><?php echo ($da["dep_header"]); ?></td>
            <td style="text-align: center">

            <center>
            <ul class="operate-menu li-width33">
            <li><a class="collapsed collapse-menu icons-href dep_edit" attr="<?php echo ($da["dep_id"]); ?>" href="javascript:void(0)"><i class="icon-edit"></i>修改</a></li>
            <li><a class="collapsed collapse-menu icons-href dep_del" attr="<?php echo ($da["dep_id"]); ?>" href="javascript:void(0)"><i
            class="icon-remove-circle"></i>删除</a></li>
            </ul>
            </center>
            </td>
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/yiyao/index.php/Dealer/Dep/index",$pnum,$pagelist,$urlPara));?>
...
<script type="text/javascript">
    ...
    $("#cre_bm").click(function(){
        ajaxData("/yiyao/index.php/Dealer/Dep/add");
    })

    $(".dep_edit").click(function(){
        var data={id:$(this).attr("attr")};
        ajaxDataPara("/yiyao/index.php/Dealer/Dep/edit",data);
    })
    $(".dep_del").click(function(){
        if(confirm("确定删除部门吗?"))
        {
            var data={id:$(this).attr("attr")};
            ajaxDataAUD("/yiyao/index.php/Dealer/Dep/del",data, true);
