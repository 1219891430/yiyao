    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
                        ...
                        <select id="in_type" class="w100 form-control">
                         ...
                         <select id="in_status" class="w100 form-control" value="v">
                            <option value="0">审核状态</option>
                             <option value="1" <?php if($urlPara['in_status'] == 1): ?>selected<?php endif; ?> >审核中</option>
                              <option value="2" <?php if($urlPara['in_status'] == 2): ?>selected<?php endif; ?>>审核通过</option>
                        </select>
                ...
                <td><ul class="operate-menu li-width33">
                    ...
                    <li><a attr="<?php echo ($vo["depot_in_id"]); ?>" class="collapsed collapse-menu icons-href in-show" href="javascript:void(0)">
            ...
            <!--表格查询结束-->
            <!--分页查询开始-->
            <?php echo W('Page/page',array("/yiyao/index.php/Dealer/DepotIn/index",$pnum,$pagelist,$urlPara));?>
            <!--分页查询结束-->
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".in-show").click(function(){
            ...
            ajaxDataPara("/yiyao/index.php/Dealer/DepotIn/show",data);
        })
        $('#find').click(function(){
            ...
            if((start==0&&end!=0)||(start!=0&&end==0))
                ...
                location.href="/yiyao/index.php/Dealer/DepotIn/index/in_status/"+$("#in_status").val()+"/in_type/"+$("#in_type").val()+"/start_time/"+start+"/end_time/"+end;
        });
    })
</script>
</body>
