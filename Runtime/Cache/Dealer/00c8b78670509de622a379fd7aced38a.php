        ...
        <div class="d_box">
            <form name="user_login" method="post" action="<?php echo U('login');?>" onSubmit="return doSubmit_user_login()">
                ...
                <h2><span>　验证码：</span><input name="verify" id="verify" class="" style="width:100px;padding-left: 15px" placeholder="验证码" type="text">
                    <img style="cursor: pointer" id="logo_verify" width="80px" height="30px" src="/index.php/Dealer/Index/verify"></h2>
                <h2><input class="st" value="登录" type="submit"></h2>
            </form>
			<!--
            <div class="code-ctrl"></div>
            <div class="code-box">
                <img class="ewm_img" src="/Public/assets/images/ewm.jpg" width="120px;">
...
$("#logo_verify").click(function(){ $(this).attr("src","/index.php/Dealer/Index/verify/tm/"+new Date().getTime()); });
