...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <dt></dt>
        ...
        <div class="row-fluid main-content">
                ...
                <table class="table list_table" id="role_table">
                    ...
                    <?php if(is_array($depot_in)): $i = 0; $__LIST__ = $depot_in;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <ul class="operate-menu li-width50">
                                ...
                                <?php if($vo['apply_status'] == 1 ): ?><li style="width:30%"><a attr="<?php echo ($vo["apply_id"]); ?>" attr_status="1" class="collapsed collapse-menu icons-href apply_edit" href="javascript:void(0)">
                                        <i class="icon-edit"></i>修改
                                    </a></li>
                                    <li style="width:30%"><a attr="<?php echo ($vo["apply_id"]); ?>" attr_status="2" class="collapsed collapse-menu icons-href apply_edit" href="javascript:void(0)">
                                ...
                                <?php else: ?>
                                    ...
                                    <li style="width:30%">
                                    <a attr="<?php echo ($vo["apply_id"]); ?>"  attr_status="3" class="collapsed collapse-menu icons-href apply_edit" href="javascript:void(0)">
               ...
               <?php echo W('Page/page',array("/index.php/Dealer/CarsaleApply/index",$pnum,$pagelist,$urlPara));?>
        </div>
...
<script type="text/javascript">
    ...
    $("#cre_apply").click(function(){
        ajaxData("/index.php/Dealer/CarsaleApply/add");
    });

    $(".apply_edit").click(function(){
        var data={apply_id:$(this).attr("attr"),status:$(this).attr("attr_status")};
        ajaxDataPara("/index.php/Dealer/CarsaleApply/edit",data);
    });

    //作废
    $(".apply_del").click(function(){
        if(confirm('确认作废吗?')){
            $.post("/index.php/Dealer/CarsaleApply/del_order", {apply_code: $(this).attr("attr")}, function (result) {
                if (result == 1) {
                    alert("操作成功");
                    location.reload();
                } else {
    ...
    $("#find").click(function(){
        ...
        if((start==0&&end!=0)||(start!=0&&end==0))
            ...
            location.href="/index.php/Dealer/CarsaleApply/index/staff_id/"+$("#staff_id").val()+"/start_time/"+start+"/end_time/"+end;
    });
</script>
</body>
</html>