...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <dt></dt>
    	...
    	<div class="row-fluid main-content">
            ...
            <?php echo W('Page/page',array("/yiyao/index.php/Dealer/GoodsPrices/index",$pnum,$pagelist,$urlPara));?>
		</div>
...
<script type="text/javascript">
    ...
    $(".goods_set").click(function(){
        ...
        ajaxDataPara("/yiyao/index.php/Dealer/GoodsPrices/setPrice",data);
    });
    ...
    $(".base_price").blur(function () {
        ...
        var obj = $(this);
        $.ajax({
            url: "/yiyao/index.php/Dealer/GoodsPrices/changePrice",
            type: "post",
            dataType: "json",
            data: {
                id: id,
    ...
    function toDecimal2(x) {
        ...
        $("#find").click(function(){
                ...
                var h = "/yiyao/index.php/Dealer/GoodsPrices?"
