...
<?php if(is_array($sub_memu)): $i = 0; $__LIST__ = $sub_memu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rightsubvo): $mod = ($i % 2 );++$i;?><dl>
    ...
    <div class="row-fluid main-content">
        ...
        <!--表格查询结束-->
        <!--分页查询开始-->
        <?php echo W('Page/page',array("/yiyao/index.php/Dealer/DepotOut/index",$pnum,$pagelist,$urlPara));?>
        <!--分页查询结束-->
	</div>
...
<script type="text/javascript">
    $(function(){
        ...
        $(".out_show").click(function(){
            ...
            ajaxDataPara("/yiyao/index.php/Dealer/DepotOut/show",data);
        });
        ...
        $('#find').click(function(){
            ...
            if((start==0&&end!=0)||(start!=0&&end==0))
                ...
                location.href="/yiyao/index.php/Dealer/DepotOut/index/out_status/"+$("#out_status").val()+"/out_type/"+$("#out_type").val()+"/start_time/"+start+"/end_time/"+end;
        });
    })
</script>
</body>
